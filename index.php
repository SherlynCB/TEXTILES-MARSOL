...
$sql = $con->prepare("SELECT id, informacion, precio , imagen FROM productos WHERE activo=1");
$sql->execute();
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/Slide1.jpeg" class="rrounded mx-auto d-block w-50" >
                </div>
                <div class="carousel-item">
                    <img src="img/Slide2.jpeg" class="rrounded mx-auto d-block w-50" >
                </div>
                
                <div class="carousel-item">
                    <img src="img/Slide4.jpeg" class="rrounded mx-auto d-block w-50" >
                </div>
            </div>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="detalles.php?id=<?php echo $mostrar['id']; ?>" class="btn btn-primary">Detalles</a>

                                    </div>
                                    <button class="btn btn-outline-primary" onclick="addProducto(<?php echo $mostrar['id']; ?>)"> Agregar </button>
                                </div>
                            </div>
                        </div>
                    </div>
