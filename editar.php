                        ...
                        <table class="table">
                            <thead>
                                ...
                                <form action="procesar_editar.php" method="POST">
                                    ...
                                    <h4>Usuario</h4>
                                    <input type="text" required value="<?php echo $mostrar['usuario'] ?>" name="txtUsuario">
                                    <h4>Nombre</h4>
                                    <input type="text" required value="<?php echo $mostrar['nombre'] ?>" name="txtNombre">
                                    <h4>Contraseña</h4>
                                    <input type="text" required value="<?php echo $mostrar['password'] ?>" name="txtContraseña">
                                    <h4>Correo</h4>
                                    <input type="text" required value="<?php echo $mostrar['correo'] ?>" name="txtCorreo">
                                    <h4>Telefono</h4>
                                    <input type="text" required value="<?php echo $mostrar['telefono'] ?>" name="txtTelefono">
                                    <H4>Cargo</H4>

                                    <select required name="txtCargo">
