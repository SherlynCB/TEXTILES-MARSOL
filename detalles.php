        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 order-md-2">
                    <h2><?php echo $mostrar['informacion'] ?></h2>
                    <h2>$<?php echo $mostrar['precio'] ?></h2>
                    <p class="lead">
                    <?php echo $mostrar['modelo'] ?></p>
                    <p class="lead">
                    <?php echo $mostrar['medidas'] ?></p>
                    <br>
                    <br>
                    <br>
                    <div class="d-grid gap-3 col-10 mx-auto">
                        <button class="btn btn-primary"> Comprar ahora</button>
                        <button class="btn btn-outline-primary" onclick="addProducto(<?php echo $id;?>)"> Agregar al carrito</button>
                    </div>
                </div>
