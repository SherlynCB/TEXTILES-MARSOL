                    ...
                    <div class="Contenido">
                        <table class="table">
                            <thead>
                                ...
                                ?>
                                <form action="procesar_editarp.php" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" value="<?php echo $mostrar['id'] ?>" name="id">
                                    <h4>Descripción</h4>
                                    <input type="text" required value="<?php echo $mostrar['informacion'] ?>" name="informacion">
                                    <h4>Medidas</h4>
                                    <input type="text" required value="<?php echo $mostrar['medidas'] ?>" name="medidas">
                                    <h4>Modelo</h4>
                                    <input type="text" required value="<?php echo $mostrar['modelo'] ?>" name="modelo">
                                    <h4>Precio</h4>
                                    <input type="text" required value="<?php echo $mostrar['precio'] ?>" name="precio">
                                    <h4>Categoria</h4>
                                    ...
                                    <h4>Imagen</h4>
                                    <img width="75" height="100" src="data:image/jpg;base64,<?php echo base64_encode($mostrar['imagen']); ?>">
                                    <br>
                                    <br>
